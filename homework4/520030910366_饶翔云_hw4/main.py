...
def evaluation(current_model):
    ...
    while not done:
        ...
        state = next_state
        r += reward
        # print('done: {}, reward: {}'.format(done, r))
    # print("Evaluation reward: {}".format(r))
    return r
...
if __name__ == '__main__':
    ...
    # compareResult([maxQ_list[0],maxQ_list[1]] , [algo_list[0], algo_list[1]], use_max=True, filename = 'return_comparison_{}_{}'.format(algo_list[0], algo_list[1]))
    # compareResult([maxQ_list[0],maxQ_list[2]] , [algo_list[0], algo_list[2]], use_max=True, filename = 'return_comparison_{}_{}'.format(algo_list[0], algo_list[2]))
    # compareResult([maxQ_list[0],maxQ_list[3]] , [algo_list[0], algo_list[3]], use_max=True, filename = 'return_comparison_{}_{}'.format(algo_list[0], algo_list[3]))
    compareResult([maxQ_list[0],maxQ_list[3]] , [algo_list[0], algo_list[3]], use_max=True, ylabel_name="maxQ", filename = 'maxQ_comparison_{}_{}'.format(algo_list[0], algo_list[3]))