...
class DynaQ_Plus:
    ...
    def update(self, s0, a0, r, s1):
        ...
        if self.model == {}:  # if the model is empty
        ...
        for _ in range(self.n_planning):
            ...
            # get the corresponding next state and reward
            reward, next_state, last_visit = self.model[state_action]
            # update Q table
            self.q_learning(state_action[0], state_action[1], reward + self.kappa * np.sqrt(self.time - last_visit), next_state)
